...
// WiFi configuration
#define WIFI_SSID "CreaTone"      // Change to your WiFi SSID
#define WIFI_PASSWORD "CreaToToToTone"  // Change to your WiFi password

// WebSocket configuration
#define WEBSOCKET_HOST "192.168.79.9"  // Change to your server IP
